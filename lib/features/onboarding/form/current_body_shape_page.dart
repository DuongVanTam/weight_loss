...
class CurrentBodyShapePage extends BaseFormPage {
  ...
  @override
  String get subtitle => 'Chọn hình dáng phù hợp nhất với cơ thể hiện tại của bạn.';
  ...
  bool isContinueEnabled(WidgetRef ref) {
    final userProfile = ref.watch(userFormServiceProvider);
    return userProfile.currentBodyShape != null;
  }
