...
class AvailableEquipmentPage extends BaseFormPage {
  const AvailableEquipmentPage({super.key});

  @override
  String get title => 'Bạn có dụng cụ nào không?';

  @override
  String get subtitle => 'Chọn những dụng cụ bạn có thể sử dụng (có thể chọn nhiều).';

  @override
  int get stepNumber => 14;

  @override
  Widget buildFormContent(BuildContext context, WidgetRef ref) {
    return const Center(
      child: Text(
        'Available Equipment Form - Coming Soon',
